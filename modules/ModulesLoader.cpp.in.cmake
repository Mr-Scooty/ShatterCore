...
/// Exposed in module shared libraries to return the module revision hash.
TC_SCRIPT_API char const* GetScriptModuleRevisionHash()
{
    return _HASH;
}

/// Exposed in module shared libraries to return the name of the module
...
/// Exposed in module shared libraries to register all module scripts to the ScriptMgr.
TC_SCRIPT_API void AddScripts()
{
@TRINITY_SCRIPTS_INVOKE@}

/// Exposed in module shared libraries to get the build directive of the module.
...
/// Registers all statically linked module scripts to the ScriptMgr.
