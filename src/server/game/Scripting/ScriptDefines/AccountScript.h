...
#ifndef SC_ACCOUNT_SCRIPT_H
#define SC_ACCOUNT_SCRIPT_H
...
class TC_GAME_API AccountScript : public ScriptObject
{
    ...
    public:
        ...
        // Called when the last_ip of an account is updated on successful authentication
        ...
        // Called when a character is created on the account, returning false denies the creation
        [[nodiscard]] virtual bool CanAccountCreateCharacter(uint32 /*accountId*/, uint8 /*charRace*/, uint8 /*charClass*/) { return true; }
};

#endif // SC_ACCOUNT_SCRIPT_H
