...
#ifndef SC_ALL_GAMEOBJECT_SCRIPT_H
#define SC_ALL_GAMEOBJECT_SCRIPT_H

#include "ScriptObject.h"

/*
 * ShatterCore keeps its 4.3.4 signature types where they are richer than
 * AzerothCore's 3.3.5a ones: OnGameObjectModifyHealth carries the
 * attacker/healer as WorldObject* (gameobjects may damage destructible
 * buildings in 4.3.4) instead of Unit*.
 */
...
class TC_GAME_API AllGameObjectScript : public ScriptObject
{
    ...
    public:
        ...
        /**
         * @brief This hook runs after the game object is saved to the database
         *
         * @param go Contains information about the GameObject
         */
        ...
        /**
         * @brief This hook runs at the end of the game object update
         *
         * @param go Contains information about the GameObject
        ...
        virtual void OnGameObjectModifyHealth(GameObject* /*go*/, WorldObject* /*attackerOrHealer*/, int32& /*change*/, SpellInfo const* /*spellInfo*/) { }
...
#endif // SC_ALL_GAMEOBJECT_SCRIPT_H
