...
#ifndef SC_ALL_CREATURE_SCRIPT_H
#define SC_ALL_CREATURE_SCRIPT_H

#include "ScriptObject.h"

/*
 * AzerothCore's OnFfaPvpStateUpdate hook is not available: its only call
 * site is AzerothCore specific trap-trigger code without a ShatterCore
 * equivalent.
 */
...
#endif // SC_ALL_CREATURE_SCRIPT_H
